...
- **Content**: Customized with user's personal academic information (Shen Chen) and latest publications from Google Scholar (as of Nov 2025).
- **Features**: Dark mode enabled (system preference detection + manual toggle).
...
└── src/                   # Source code directory
    ...
    │   ├── sections/      # Page sections (Activity, Publications, etc.)
    │   ├── Collapse.tsx   # Reusable collapse component
    ...
    │   └── mockData.ts    # Mock data for the app (Customized)
    ├── styles/            # Style files
